...
# Foreign keys below are emitted without column options, intended for ERD visualization (not enforcement).
ActiveRecord::Schema [8.0].define (version: 2026_01_12_164555) do
