...
# Foreign keys are emitted without column options for ERD visualization (not enforcement).
ActiveRecord::Schema [8.0].define (version: 2026_01_12_165808) do
  ...
  create_table "hackathon_agile_minds_source_banking_clean", force: :cascade do |t|
    # UNITY CATALOG STUB: endpoint appears in lineage but not in information_schema
  end
